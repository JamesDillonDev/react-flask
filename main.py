...
from reactflask import Hyperlink, Redirect, Dropdown
...
dropdown_example = Dropdown(body_all, options=["Option 1", "Option 2", "Option 3"], value="Option 2", onChange=on_dropdown_change, width=200)
dropdown_example.grid(row=8, column=0, columnspan=2, padx=8, pady=8)
